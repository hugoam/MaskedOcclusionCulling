...
template<int N, class T_Index> FORCE_INLINE void VtxFetch4(__mw *v, const T_Index *inTrisPtr, int triVtx, const float *inVtx, int numLanes)
{
...
template<> FORCE_INLINE void VtxFetch4<0, uint32_t>(__mw *v, const uint32_t *inTrisPtr, int triVtx, const float *inVtx, int numLanes)
{
	// Workaround for unused parameter warning
	(void)v; (void)inTrisPtr; (void)triVtx; (void)inVtx; (void)numLanes;
}

template<> FORCE_INLINE void VtxFetch4<0, uint16_t>(__mw *v, const uint16_t *inTrisPtr, int triVtx, const float *inVtx, int numLanes)
{
	// Workaround for unused parameter warning
	(void)v; (void)inTrisPtr; (void)triVtx; (void)inVtx; (void)numLanes;
}
...
public:
	...
	FORCE_INLINE void GatherVerticesFast(__mw *vtxX, __mw *vtxY, __mw *vtxW, const float *inVtx, const T_Index *inTrisPtr, int numLanes)
	{
	...
	template<int TEST_Z, int FAST_GATHER, class T_Index>
	FORCE_INLINE CullingResult RenderTriangles(const float *inVtx, const T_Index *inTris, int nTris, const float *modelToClipMatrix, BackfaceWinding bfWinding, ClipPlanes clipPlaneMask, const VertexLayout &vtxLayout)
	{
		assert(mMaskedHiZBuffer != nullptr);
		...
		const T_Index *inTrisPtr = inTris;
	...
	CullingResult RenderTriangles(const float *inVtx, const uint32_t *inTris, int nTris, const float *modelToClipMatrix, BackfaceWinding bfWinding, ClipPlanes clipPlaneMask, const VertexLayout &vtxLayout) override
	{
	...
	CullingResult RenderTriangles(const float *inVtx, const uint16_t *inTris, int nTris, const float *modelToClipMatrix, BackfaceWinding bfWinding, ClipPlanes clipPlaneMask, const VertexLayout &vtxLayout) override
	{
        CullingResult retVal;
	...
	template<bool FAST_GATHER, class T_Index>
	FORCE_INLINE void BinTriangles(const float *inVtx, const T_Index *inTris, int nTris, TriList *triLists, unsigned int nBinsW, unsigned int nBinsH, const float *modelToClipMatrix, BackfaceWinding bfWinding, ClipPlanes clipPlaneMask, const VertexLayout &vtxLayout)
	{
		assert(mMaskedHiZBuffer != nullptr);
    ...
    template<int FAST_GATHER, class T_Index>
    void GatherTransformClip( int & clipHead, int & clipTail, int & numLanes, int nTris, int & triIndex, __mw * vtxX, __mw * vtxY, __mw * vtxW, const float * inVtx, const T_Index * &inTrisPtr, const VertexLayout & vtxLayout, const float * modelToClipMatrix, __m128 * clipTriBuffer, unsigned int &triMask, ClipPlanes clipPlaneMask )
    {
        //////////////////////////////////////////////////////////////////////////////
